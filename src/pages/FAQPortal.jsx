      ...
      <div className="space-y-4 max-w-2xl mx-auto text-center relative z-40">
        ...
        {(communityStats.total_contributors > 0 || communityStats.total_approved > 0) && (
          <div className="mt-3 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm">
            <div className="flex items-center space-x-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-[#111827] dark:text-gray-100 px-3 py-1.5 rounded-full shadow-sm">
            ...
            <div className="flex items-center space-x-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-[#111827] dark:text-gray-100 px-3 py-1.5 rounded-full shadow-sm">
              ...
              <span className="text-gray-500 dark:text-gray-400">approved answers</span>
            </div>
            <div className="flex items-center space-x-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-[#111827] dark:text-gray-100 px-3 py-1.5 rounded-full shadow-sm">
              <span className="font-bold">{communityStats.total_submissions}</span>
              <span className="text-gray-500 dark:text-gray-400">total suggestions</span>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {contributions.slice(0, 4).map(contrib => (
              <div key={contrib.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex flex-col justify-between hover:border-[#111827] dark:hover:border-gray-100 transition shadow-sm">
                <div>
                  <div className="flex items-center space-x-2">
                    <span className="bg-[#111827] dark:bg-gray-100 text-white dark:text-gray-900 text-[9px] font-bold uppercase tracking-wide px-2 py-0.5 rounded">
                      Approved Answer
                    </span>
                    {contrib.hash_id && (
                      <span className="bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300 text-[9px] font-mono px-2 py-0.5 rounded">#{contrib.hash_id}</span>
                    )}
                  </div>
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-1.5 items-center">
                        ...
                        {/* Stale info badge */}
                        {stale && (
                          <span className="bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300 border border-gray-200 dark:border-gray-600 text-[10px] px-2 py-0.5 rounded font-medium flex items-center space-x-1">
